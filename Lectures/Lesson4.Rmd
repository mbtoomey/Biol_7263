...
For some basic operation in the shell see - [Navigating the UNIX shell](Lectures/Shell_Navigation.html)
...
### Uisng `sed` to clean up the headers 
...
sed 's/>/ \n>/g' GCF_015476345.1_ZJU1.0_rna.fna | sed -n '/BCO2/,/^\s/p' > BCO2.txt
